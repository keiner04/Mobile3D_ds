...
export default function HomeScreen({ navigation }) {
  ...
  const sincronizarReceitas = async () => {
    setCarregando(true);
    try {
      const response = await fetch('https://raw.githubusercontent.com/keiner04/Mobile3D_ds/refs/heads/main/receitas.json');
